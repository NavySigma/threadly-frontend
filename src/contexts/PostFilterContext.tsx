...
const DEFAULT: PostFilter = { search: "", category_id: "", sort: "latest", answer: "all" };
...
export function PostFilterProvider({ children }: { children: ReactNode }) {
  ...
  return (
    <PostFilterContext.Provider value={{ filter, setSearch, setCategory, setSort, setAnswer, resetFilter, hasActiveFilter }}>
      {children}
