...
const dummyPosts = [
  {
    ...
    excerpt:
      "I am building a React application and need to implement JWT-based authentication. What are the best practices for storing tokens and handling refresh logic?",
  ...
  },
  {
    ...
    excerpt:
      "I recently enabled strict mode in my TypeScript project and noticed the `noUncheckedIndexedAccess` flag. Can someone explain what it does and how it affects object access?",
  ...
  },
  {
    ...
    excerpt:
      "I have a simple grid layout that renders perfectly in Chrome but breaks in Firefox. I am using `grid-template-columns: repeat(auto-fill, minmax(250px, 1fr))`.",
  ...
  },
  {
    ...
    excerpt:
      "I am trying to wrap my head around how service providers work in Laravel. When should I create a custom service provider versus binding directly in AppServiceProvider?",
  ...
  },
  {
    id: "5",
    title:
      "PostgreSQL: how to optimize a query with multiple JOINs on large tables?",
    excerpt:
      "I have a query that JOINs 5 tables, each with millions of rows. Execution time is over 30 seconds. I already indexed the foreign key columns. What else can I try?",
  ...
  return (
    <div>
      <div className="home-header">
        <h1>All Questions</h1>
        {user ? (
          <Link to="/questions/ask" className="btn btn-orange">
            Ask Question
          </Link>
        ) : (
