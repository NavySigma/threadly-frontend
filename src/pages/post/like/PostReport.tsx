...
export default function PostReport({ postId }: PostReportProps) {
  const storageKey = `reported_post_${postId}`;
  ...
  const reportMutation = useMutation<ReportResponse, ApiError>({
    ...
    onError: (error: ApiError) => {
      ...
      if (error.errors) {
        ...
        alert(firstError[0] || "Gagal melaporkan.");
      } else {
    ...
    <>
      <button
        ...
        style={{
          ...
          background: reported ? "#fef2f2" : "none",
